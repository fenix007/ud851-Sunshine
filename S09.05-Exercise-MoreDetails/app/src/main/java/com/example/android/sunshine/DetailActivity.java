...
//  TODO (19) Create constant int values representing each column name's position above
    ...
    private TextView mDayDate, mDayWeatherDescr, mDayHighTemp,
            mLowHighTemp, mDayHumidity, mDayPressure, mDayWind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDayWeatherDescr = (TextView) findViewById(R.id.tv_day_weather_descr);
        mDayHighTemp = (TextView) findViewById(R.id.tv_day_high_temp);
        mLowHighTemp = (TextView) findViewById(R.id.tv_day_low_temp);
...
//          TODO (23) If the loader requested is our detail loader, return the appropriate CursorLoader
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (data.getCount() != 0) {
            long DateColumn = data.getLong(INDEX_WEATHER_DATE);
            String dayDate = SunshineDateUtils.getFriendlyDateString(this, DateColumn, true);
            ...
            String highAndLowTemperature = SunshineWeatherUtils.formatHighLows(this, highInCelsius, lowInCelsius);

            String weatherSummary = dayDate + " - " + description + " - " + highAndLowTemperature;
